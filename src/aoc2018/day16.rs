...
fn operate(reg: &mut [i32], ins: &Vec4) {
    reg[ins[3] as usize] = match ins[0] {
        ...
        1 => reg[ins[1] as usize] + ins[2] as i32,
        2 => reg[ins[1] as usize] * reg[ins[2] as usize],
        3 => reg[ins[1] as usize] * ins[2] as i32,
        4 => reg[ins[1] as usize] & reg[ins[2] as usize],
        5 => reg[ins[1] as usize] & ins[2] as i32,
        6 => reg[ins[1] as usize] | reg[ins[2] as usize],
        7 => reg[ins[1] as usize] | ins[2] as i32,
        8 => reg[ins[1] as usize],
        9 => ins[1] as i32,
        10 => i32::from(ins[1] as i32 > reg[ins[2] as usize]),
        11 => i32::from(reg[ins[1] as usize] > ins[2] as i32),
        12 => i32::from(reg[ins[1] as usize] > reg[ins[2] as usize]),
        13 => i32::from(ins[1] as i32 == reg[ins[2] as usize]),
        14 => i32::from(reg[ins[1] as usize] == ins[2] as i32),
